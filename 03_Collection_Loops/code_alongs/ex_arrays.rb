...
if catergories.includes?("Animals" && "Shopping")
  categories << "Family" 
end
...
assert_equal("Animals, Family, Florida, Music, Shopping, Weather", categories.sort_by!.join(', ') )
...
if categories.size > 5 #get it's length
  categories.pop(categories.size)# empty the array
  categories << "Misc"
end
